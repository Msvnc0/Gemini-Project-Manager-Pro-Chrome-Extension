...
export default [
  ...
  prettierConfig,
  {
    languageOptions: {
      ...
      globals: {
        ...
        // content.js
        gpmInit: 'readonly',
        gpmResetObserversFlag: 'readonly',
        gpmCleanupObservers: 'readonly',
        gpmResetState: 'readonly',
        ...
        GPMHistory: 'readonly',
        GPMFavoritesManager: 'readonly',
        GPMUsageTracker: 'readonly',
        GPMBackupManager: 'readonly',
        GPMSyncManager: 'readonly',
        GPMIntegrityCheck: 'readonly',
        GPMContextRecovery: 'readonly',
        GPMKeyboardShortcuts: 'readonly',
  ...
  {
    ignores: ['node_modules/', 'icons/', '_locales/', '*.md', '*.json', 'plans/'],
  },
];
